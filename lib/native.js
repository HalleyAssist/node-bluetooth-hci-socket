...
class BluetoothHciSocketWrapped extends BluetoothHciSocket {
  constructor(...args) {
    ...
    this._disconnectWorkaroundOnDataBound = this._disconnectWorkaroundOnData.bind(this)
    this.on('predata', this._disconnectWorkaroundOnDataBound)
  }

  _disconnectWorkaroundOnData(data){    
  ...
  stop(){
    this.removeListener('predata', this._disconnectWorkaroundOnDataBound)
    this._done = true
